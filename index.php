...
<section class="my-4 container-fluid">
	...
	<div class="row">
		<div class="col-lg-6 col-md-6 col-12">
			<img src="images/a.jpg" class="img-fluid imgsize">
		</div>
		<div class="col-lg-6 col-md-6 col-12">
			<h3> Good Luck</h3>
			<p> Lorem ipsum eiusmod reprehenderit velit dolor ullamco qui ullamco in sint pariatur commodo commodo sit. Sit eu minim proident cupidatat ut eu eu ea voluptate commodo pariatur. Sunt sint sint incididunt dolore quis eiusmod sunt dolore eiusmod mollit eiusmod consectetur esse nulla deserunt cillum laborum nisi. </p>
	...
	<div class="row">
		<div class="col-lg-4 col-md-4 col-12">
			...
			<div class="card" style="width:400px">
				<img class="card-img-top" src="images/c.jpg" alt="Card image" style="width:100%">
				<div class="card-body">
					<h4 class="card-title">Dancing </h4>
...
<section class="my-4 container-fluid">
	...
	<h3 class="text-center mb-4">Gallery</h3>
         ...
         <div class="row ">
         	<div class="col-la-4 col-md-4 col-12 mb-4">
...
<section class="my-4 container-fluid">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" name="comment" autocomplete="off">
    </textarea>
    </div>
...
<footer >
  <p class="text-center bg-dark text-white p-3">@goodluck</p>
</footer>
